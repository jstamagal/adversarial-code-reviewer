...
- 🆕 Prompt injection protection IMPROVED (expanded patterns for more attack variations, 30/31 tests passing, 1 test still failing due to pattern overlap complexity)
...
- [x] Implement `acr patterns` command
  ...
  - [x] Show pattern details
  - [x] List custom patterns
...
- [x] Implement finding annotations
  - [x] Allow marking findings as false positive
  - [x] Allow marking findings as accepted risk
  - [x] Allow marking findings as in-progress
  - [x] Persist annotations in .acr-state file
